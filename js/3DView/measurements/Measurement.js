...
////////////////////////////////////////////////////////////////////////////////
class MeasurementGizmoMaterial extends THREE.MeshBasicMaterial {
...
class MeasurementGizmo extends THREE.Object3D{
	constructor(measurement, container ) {
		...
		this.transformGizmo = function(mesh, translate, rotate) {
			if ( translate ) {
				mesh.geometry.applyMatrix4( new THREE.Matrix4().makeTranslation( translate.x, translate.y, translate.z ) );
			}
			if ( rotate ) {
