...
class MeasurementGizmoDistance extends MeasurementGizmo {
    constructor(measurement, container) {
        ...
        this.handleGizmos = {
            ...
            'TOPLINE': [
                new THREE.Mesh(new THREE.CylinderGeometry(1, 1, 1, 4, 1, false), new MeasurementGizmoMaterial({
                    color: 0x0000FF,
                    opacity: 0.4
                })),
            ...
            'STARTLINE': [
                new THREE.Mesh(new THREE.CylinderGeometry(0.5, 0.5, 1, 4, 1, false), new MeasurementGizmoMaterial({
                    color: 0x000000,
                    opacity: 0.1
                })),
                new THREE.Vector3(0, 0.5, 0),
            ...
            'START': [
                new THREE.Mesh(new THREE.SphereGeometry(2), new MeasurementGizmoMaterial({color: 0x0000FF, opacity: 0.4}))
            ],
            'END': [
                new THREE.Mesh(new THREE.SphereGeometry(2), new MeasurementGizmoMaterial({color: 0x0000FF, opacity: 0.4}))
            ],
            'STARTARROW': [
                new THREE.Mesh(new THREE.CylinderGeometry(3, 0, 6, 8, 1, false), new MeasurementGizmoMaterial({
                    color: 0x0000FF,
                    opacity: 0.4
                })),
        ...
        this.pickerGizmos = {
            ...
            'TOPLINE': [
                new THREE.Mesh(new THREE.CylinderGeometry(3, 3, 1, 4, 1, false), new MeasurementGizmoMaterial({visible: false})),
                new THREE.Vector3(0, 0.5, 0),
                new THREE.Vector3(Math.PI / 2, 0, 0)
            ],
            'STARTARROW': [
                new THREE.Mesh(new THREE.SphereGeometry(4), new MeasurementGizmoMaterial({visible: false}))
            ],
            'ENDARROW': [
                new THREE.Mesh(new THREE.SphereGeometry(4), new MeasurementGizmoMaterial({visible: false}))
            ],
